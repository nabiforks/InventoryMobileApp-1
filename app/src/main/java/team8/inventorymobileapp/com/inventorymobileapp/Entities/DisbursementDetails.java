...
public class DisbursementDetails extends HashMap<String, String> {
    ...
    final static String DisbursementDetailsURL = "http://"+Constant.ipAddress+"/InventoryWCF/WCF/EmployeeService.svc/DisbursementDetails";
    ...
    public DisbursementDetails(String DisbursementCode, String CollectionPointName, String NeededQuantity, String DepartmentName , String RepName, String Status,
                               String ActualQuantity, String ItemDescription,String RequestCode ) {
    ...
    public static ArrayList<DisbursementDetails> dDetails(String id,String email,String password) {
        ArrayList<DisbursementDetails> list = new ArrayList<DisbursementDetails>();
        JSONArray a = JSONParser.getJSONArrayFromUrl(DisbursementDetailsURL + "/" + id+"/"+email+"/"+password);
        try {
